...
},{"../lib/callClient":2,"../lib/util":6,"../module/member-log/cgi":7,"../module/member-log/tmpl/manage-list":8}],2:[function(require,module,exports){
'use strict';
/*
...
},{"../../lib/request":4}],8:[function(require,module,exports){
'use strict;'
var _ = {};
var escapeMap = {
    '&': '&amp;',
...
;
__p += '\r\n<li><div>\r\n    <div class="nick">' +
((__t = (locals.msg[i].nick)) == null ? '' : __t) +
'</div>\r\n    <div class="time">' +
((__t = (locals.msg[i].time)) == null ? '' : __t) +
'</div>\r\n    <div class="content">' +
((__t = (locals.msg[i].content)) == null ? '' : __t) +
'</div>\r\n</div></li>\r\n';
};
