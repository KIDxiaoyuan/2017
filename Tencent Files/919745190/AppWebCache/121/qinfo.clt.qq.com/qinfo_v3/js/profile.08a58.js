...
},{"lodash._htmlescapes":2}],2:[function(require,module,exports){
/**
 * Lo-Dash 2.4.1 (Custom Build) <http://lodash.com/>
 * Build: `lodash modularize modern exports="npm" -o ./npm/`
 * Copyright 2012-2013 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._htmlescapes":2,"lodash.keys":10}],6:[function(require,module,exports){
(function (global){
/**
...
},{"lodash._escapehtmlchar":1,"lodash._reunescapedhtml":5,"lodash.keys":10}],9:[function(require,module,exports){
/**
 * Lo-Dash 2.4.1 (Custom Build) <http://lodash.com/>
 * Build: `lodash modularize modern exports="npm" -o ./npm/`
 * Copyright 2012-2013 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._isnative":3,"lodash._shimkeys":7,"lodash.isobject":9}],11:[function(require,module,exports){
/**
...
},{"lodash._root":6}],12:[function(require,module,exports){
'use strict';
...
window.onSave = function(from) {
    ...
    if (typeof info.gName !== 'undefined' && info.gName !== null) {
        if ((ginfo.gtype === 2 || ginfo.gtype === 3 || ginfo.gtype === 4 || isBuluoGroup) && util.getTextLength(info.gName, 3) < 6) {
            tdw('fail_edit', 1);

            client.alert(1, '群资料卡', '群名称不能少于2个字');
            return;
        }
    }
    // 同城群介绍至少15个字
    if (typeof info.gRIntro !== 'undefined' && info.gRIntro !== null) {
        if ((ginfo.gtype === 2 || ginfo.gtype === 3 || ginfo.gtype === 4 || isBuluoGroup) && util.getTextLength(info.gRIntro, 3) < 45) {
            tdw('fail_edit', 2);
            client.alert(1, '群资料卡', '群介绍不能少于15个字');
            return;
        }
    }
    ...
    if (info) return doSave(info, function() {
        if (ginfo.gtype === 2 || ginfo.gtype === 4) {
            if(isBuluoGroup){
                client.alert(1, '群资料卡', '您已提交群资料修改申请，由于本群是同城群且绑定兴趣，资料需审核后才会更新外部显示。');
            }else{
                client.alert(1, '群资料卡', '您已提交群资料修改申请，由于本群是同城群，资料需审核后才会更新外部显示。');
            }
        }else if(isBuluoGroup){
            client.alert(1, '群资料卡', '您已提交群资料修改申请，由于本群绑定兴趣，资料需审核后才会更新外部显示。');
        }
        close();
    });
...
window.addEventListener('load', function() {
    ...
    //tribe_status 0、未申请 1、部落群仅修改普通资料审核中 2、申请新增绑定中 3、申请修改绑定中 4、审核完成-成功 5、审核完成-失败
    //app_privilege_flag=16576 0x4000
    getGinfo(function(err, res) {
        if (err) return void 0;
        ginfo = res;

        isBuluoGroup = res.app_privilege_flag & 0x4000;//Boolean(res.app_privilege_flag); // 0-取消部落群标记 非0-设置部落群标记
        if(res.tribe_status === 4){
            buluoEdit = false;
		}else if(res.tribe_status === 1 || res.tribe_statue === 0){
			buluoEdit = true;
        //}else if(res.tribe_status === 0){
        //    buluoEdit = true;
            //isBuluoGroup = false;
        }else{
            buluoEdit = false;
        ...
        renderTags(res.tags);
        renderWording(res.gtype, isBuluoGroup,buluoEdit);
        //renderWording(4, isBuluoGroup,buluoEdit);
...
},{"../lib/callClient":13,"../lib/util":18,"../module/profile/catalog":20,"../module/profile/cgi":21,"../module/profile/detail":22,"../module/profile/ginfo":25,"../module/profile/intro":26,"../module/profile/name":29,"../module/profile/report":30,"../module/profile/tag":31,"../module/profile/type":34,"../module/profile/wording":35}],13:[function(require,module,exports){
'use strict';
/*
...
},{"./callClient":13,"./util":18}],15:[function(require,module,exports){
'use strict';
//ajax请求
var util = require('./util');
...
db.post = post;
db.bkn = bkn;
},{"./report":14,"./requestrep":16,"./util":18}],16:[function(require,module,exports){
'use strict';
/**
...
},{"./report":14}],17:[function(require,module,exports){
'use strict;'
var _ = {};
var escapeMap = {
    '&': '&amp;',
...
},{"./tmpl/select":17,"./util":18}],20:[function(require,module,exports){
'use strict';
...
},{"../../lib/request":15}],22:[function(require,module,exports){
// 'use strict';
...
},{"../../lib/util":18,"../../lib/widget":19,"./catalog":20,"./cgi":21,"./tmpl/select":33}],23:[function(require,module,exports){
'use strict';
...
(function faceToIndex() {
    if (!faceWordingMap) {
        ...
        faceWording.forEach(function(word, index) {
            ...
            $(".face-selector a[i='"+index+"']").attr('aria-label','选择表情:'+word);
        });
    }
    if (!lnWordingMap) {
        lnWordingMap = {};
...
},{"./cgi":21}],26:[function(require,module,exports){
'use strict';
...
window.addEventListener('load', function() {
    ...
    var bodyCls = isTim ? 'editor tim_editor' : 'editor';

    doc.write('<head><link rel="stylesheet" href="' + document.head.querySelector('link').href + '"></head><body class="' + bodyCls + '"><div id="intro" class="border f-left tim-intro" contenteditable="true"></div></body>');
...
},{"../../lib/util":18,"./editor":23,"./face":24,"./report":30,"./xss":36,"lodash.escape":8,"lodash.unescape":11}],27:[function(require,module,exports){
'use strict';
...
},{"../../lib/callClient":13,"../../lib/widget":19,"./catalog":20,"./cgi":21,"./jxconfig":28,"./tmpl/select":33}],28:[function(require,module,exports){
'use strict';
...
},{"../../lib/util":18}],30:[function(require,module,exports){
'use strict';
...
module.exports = tdw;
},{"../../lib/callClient":13,"../../lib/report":14,"../../lib/util":18}],31:[function(require,module,exports){
'use strict';
...
},{"../../lib/callClient":13,"../../lib/util":18,"./cgi":21,"./ginfo":25,"./report":30,"./tmpl/label":32,"lodash.escape":8}],32:[function(require,module,exports){
'use strict;'
var _ = {};
var escapeMap = {
    '&': '&amp;',
...
},{"../../lib/util":18,"../../lib/widget":19,"./catalog":20,"./detail":22,"./jiaxiao":27,"./report":30,"./tmpl/select":33,"lodash.unescape":11}],35:[function(require,module,exports){
'use strict';
...
var texts = ['本群是同城群，资料修改需要人工审核，请认真填写。',
    '群资料已提交同城群审核，通过后才会更新外部显示。',
    '本群已绑定兴趣，资料修改需要人工审核，请认真填写。',
    '本群已是同城群且绑定兴趣，资料修改需要人工审核，请认真填写。',
    '群资料已提交审核，通过后才会更新外部显示'
];
...
module.exports = function(gtype, isBuluoGroup,buluoEdit) {
    var $text = $wording.find('.text');

    void 0;

    if(isBuluoGroup && buluoEdit){
        ...
        if(gtype === 2) {
            ...
            if(isBuluoGroup && !buluoEdit){
                $text.text(texts[3]);
            // }else if(isBuluoGroup && buluoEdit){
            //     $text.text(texts[4]);
            }else{
                $text.text(texts[0]);
            }
